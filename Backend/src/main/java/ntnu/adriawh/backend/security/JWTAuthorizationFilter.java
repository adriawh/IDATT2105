package ntnu.adriawh.backend.security;

import io.jsonwebtoken.*;
import io.jsonwebtoken.security.Keys;
import ntnu.adriawh.backend.Controller.Controller;
import ntnu.adriawh.backend.Controller.TokenController;
        ...
        try {
            ...
            if (authenticationHeader == null || !authenticationHeader.startsWith(PREFIX)){
                ...
                if (claims.getBody().get("authorities") != null) {
                    ...
                    authorities = (List) claims.getBody().get("authorities");
